...
struct PNTVertex
{
	...
	bool operator==(const PNTVertex& rhs) const
	{
		...
		DirectX::XMVectorEqualR(&position, DirectX::XMLoadFloat3(&(this->mPosition)), DirectX::XMLoadFloat3(&rhs.mPosition));
		DirectX::XMVectorEqualR(&normal, DirectX::XMLoadFloat3(&(this->mNormal)), DirectX::XMLoadFloat3(&rhs.mNormal));
